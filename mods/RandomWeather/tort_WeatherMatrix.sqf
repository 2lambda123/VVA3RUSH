...
Or as a oneliner:
0 = [8,[10,-50,80], 9,[40,1,20], 16,[-30,77,30], 17,[30,77,90], 22,[30,77,90], 8,[10,50,70], 12,[10,50,80], 16,[30,77,90], 17,[30,77,90]] execVM "\@tort_WeatherMatrix\script\tort_WeatherMatrix.sqf";
*/
...
if ((_parameters select _prevElem) < (_parameters select _nextElem)) then {_length = (_parameters select _nextElem) - (_parameters select _prevElem);
   } else {
   _length = 24 - (_parameters select _prevElem) + (_parameters select _nextElem);
};

// find out how far we are in current cycle (in %)
if ((_parameters select _prevElem) <= _now) then {_elapsed = (_now - (_parameters select _prevElem))
   } else {
...
if (_now < (_parameters select _nextElem)) then {_remainingSeconds = ((_parameters select _nextElem) - _now) * 3600
   } else {
